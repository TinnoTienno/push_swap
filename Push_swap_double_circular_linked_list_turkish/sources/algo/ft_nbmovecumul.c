...
/*   Updated: 2024/02/09 12:55:27 by eschussl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_nbmovecumulcalc(t_pselement *current)
{
	if (current->nbmovea == 0 || current->nbmoveb == 0)
		current->nbmoveboth = ft_absolu(current->nbmoveb) + ft_absolu(current->nbmovea);
	...
	else if (current->nbmovea < 0 && current->nbmoveb < 0)
	{
		...
		current->nbmoveboth = ft_absolu(current->nbmovea) + ft_absolu(current->nbmoveb);
}
